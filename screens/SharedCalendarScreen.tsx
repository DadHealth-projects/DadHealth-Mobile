...
export default function SharedCalendarScreen() {
  ...
  const load = useCallback(async () => {
    ...
    if (ownedResult.error || sharedResult.error) { setError('We could not load the shared calendar. Please try again.'); setLoading(false); return; }
    ...
    if (eventResult.error || milestoneResult?.error) setError('We could not load the shared calendar details. Please try again.');
  ...
  const acceptInvite = useCallback(async (token: string) => {
    ...
    try {
      ...
      setMessage("You're connected to the shared calendar."); await load();
