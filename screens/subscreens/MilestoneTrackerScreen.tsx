...
export default function MilestoneTrackerScreen() {
  ...
  const saveMilestone = useCallback(async () => {
    ...
    if (saveResult.error) setFormError('We could not save this milestone. Please try again.');
    else {
