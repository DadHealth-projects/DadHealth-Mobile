...
export default function MilestoneTrackerScreen() {
  ...
  useEffect(() => {
    ...
    setMilestones(dashboardData.milestones.map((milestone) => ({ ...milestone, tag: 'moment' })));
  }, [dashboardData?.milestones, milestones.length]);
