...
type UpgradeProCardProps = {
  onPress?: () => void;
  /**
   * Real, server-derived line about this member's own week. Never a fabricated
   * figure — when there is nothing true to say, the generic body copy is used.
   */
  insight?: string | null;
  ctaLabel?: string;
