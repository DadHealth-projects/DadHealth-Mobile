...
function BondScoreCard({ score, trend }: { score: number | null; trend: number | null }) {
  ...
  return (
    <View className="bg-lime rounded-t-[18px] px-xl pt-xl pb-lg overflow-hidden">
      <View className="flex-row items-center gap-lg">
        <View>
          <Text className="font-heading text-dark text-[56px] leading-[52px]">{value}</Text>
        ...
        <View className="flex-1">
          <View className="flex-row items-center gap-sm mb-md">
            ...
            <Text className="font-heading-bold text-dark text-[11px]">{formattedTrend.arrow}{formattedTrend.change == null ? '' : ` ${formattedTrend.change} pts`}</Text>
          </View>
